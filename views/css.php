          ...
          <td>
            <fieldset>
              <legend class="screen-reader-text">
                <span>CSS files to combine</span>
              </legend>
              
              <?php 
              $wp = false;
              if( isset($assets['css']) ) 
                foreach($assets['css'] as $asset): $asset = trim($asset);?>
                ...
                <label for="<?php echo $id; ?>">
                  ...
                  <input name="combine[<?php echo $id; ?>][<?php echo $asset; ?>]" type="checkbox" id="<?php echo $id; ?>" value="1" <?php if( in_array( $asset, $current['combine']['css'] ) ) echo 'checked="checked"'; ?>/>
      ...
      <tbody>
        <tr valign="top">
          ...
          <td>
            <fieldset>
              <legend class="screen-reader-text">
                <span>CSS files to compress</span>
              </legend>
              ...
              if( isset($assets['css']) ) 
                ...
                <label for="<?php echo $id; ?>">
                  ...
                  <input name="compress[<?php echo $id; ?>][<?php echo $asset; ?>]" type="checkbox" id="<?php echo $id; ?>" value="1" <?php if( in_array( $asset, $current['compress']['css'] ) ) echo 'checked="checked"'; ?>/>
                  <?php echo basename($asset); ?> <code><?php echo str_replace( str_replace( "\\", "/", ABSPATH ), "", $asset ); ?></code>
                </label>
                <br/>
